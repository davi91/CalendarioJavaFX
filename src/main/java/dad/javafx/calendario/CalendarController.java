...
public class CalendarController implements Initializable {
    ...
    @FXML
    private ArrayList<MonthCalendar> monthList = new ArrayList<>();
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		yearLbl.textProperty().bindBidirectional(year, new NumberStringConverter());
		
		int j = 1;
		for( MonthCalendar cal : monthList ) {
